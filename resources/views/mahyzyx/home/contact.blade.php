...
<header> <a class="fanhui" href="javascript:window.history.back();"></a> <strong>预约报名</strong> <a href="#" class="menubtn"></a> 
...
<!-- 华尚推广--></header>
  ...
  <!--主题内容的开始-->
  <div class="zymain">
    <div class="zybt"><strong>预约报名</strong></div>
    <div class="zy_nr">
    <iframe frameborder="0" height="500" marginheight="0" marginwidth="0" scrolling="no" src="http://m.ahyzyx.com/baoming/baoming.html" width="100%"></iframe>
    </div>
  </div>
  <!--主题内容的结束--> 
