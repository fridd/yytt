...
<!-- 华尚推广--></header>
  ...
  <div class="zymain">
    ...
    <div class="cgal_nr">
     <ul>
       <li><a href="{{ asset('mahyzyx/shizi') }}"><div class="lzj"><img src="{{ asset('mahyzyx/images/1-161222141150334.JPG') }}"/></div>师资介绍</a></li>
       <li><a href="/html/case/11.html"><div class="lzj"><img src="{{ asset('mahyzyx/images/1-16021914025X23-lp.jpg') }}"/></div>校区环境</a></li>
       <li><a href="/html/case/9.html"><div class="lzj"><img src="{{ asset('mahyzyx/images/1-161222141K95c.JPG') }}"/></div>校区分布</a></li>
       <div class="clear"></div>
     </ul>
  </div>
    <!--更换内容结束-->
