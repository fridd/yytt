...
<title>校区分布_艺朝艺夕安徽</title>
<meta name="keywords" content="艺朝艺夕,创意美术,合肥少儿艺术培训,合肥少儿" />
<meta name="description" content="艺朝艺夕,创意美术,合肥少儿艺术培训,合肥少儿舞蹈,合肥少儿美术,合肥少儿钢琴,合肥少儿电钢琴" />
...
<div id="pgcontainer">
  ...
  <!--头部的开始-->
  <link rel="shortcut icon" href="http://www.ahyzyx.com/favicon.ico">
<header> <a class="fanhui" href="javascript:window.history.back();"></a> <strong>环境介绍</strong> <a href="#" class="menubtn"></a> 
...
window.BX_CLIENT_ID = 52137; // 帐号ID
(function() {
...
<!-- 华尚推广--></header>
  ...
  <!--主题内容的开始-->
  <div class="zymain">
    <div class="zybt"><strong>环境介绍</strong></div>
    <div class="zy_nr">
       <h2>校区分布</h2>
<script src="/ckplayer/ckplayer_common.php?id=1" language="javascript"></script>
﻿<script type="text/javascript">
var videoinfo={
	basehost:'http://m.ahyzyx.com',
	path:'',
	vurl:'',
	html5url:'',
	title:'校区分布',
	litpic:'/uploads/161222/1-161222141K95c.JPG',
	keytime:'',
	keyword:'',
...
var videoinfo={
	...
	arcurl:encodeURIComponent(window.location.href)
    	...
    	<iframe frameborder="0" height="578" marginheight="0" marginwidth="0" scrolling="no" src="http://www.ahyzyx.com/ditu/yishu.html" width="100%"></iframe>
    </div>
  </div>
  <!--主题内容的结束-->
...
<!--顶部右侧点击向左移动js-->
<script type="text/javascript" src="{{ asset('mahyzyx/js/jquery-1.9.1.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('mahyzyx/js/menu.js') }}"></script>
</html>
