    ...
    <div class="h__w">
        <div class="grid">
            <div class="col span-4 small-12 xsmall-6">
                <h1 class="h__logo"><a href="{{ asset('power/index') }}"  title="跑沃尔运动馆"><img src="{{ asset('paowoer/images/logo.png') }}"  alt="Leader Bikes" /></a></h1>
            </div>
...
position: relative;"> 
    ...
    <div class="m__w" style="margin-top: 30px">
        <!--[if lt IE 8]>
            <p class="browserupgrade">You are using an <strong>outdated</strong> browser. Please <a href="http://www.paowoer.com/" >upgrade your browser</a> to improve your experience.</p>
        <![endif]-->
        <div class="page__t col span-4 xsmall-6">
            <h1>Paowoer</h1>
            <hr class=>
            <p class=STYLE4>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;跑沃尔（Paowoer)&nbsp;&nbsp;是一家具有国际标准的专业运动训练馆，专注于3-18岁少儿运动基础、运动技能和身体素质的提升，引进国际最前沿的体能训练理念和技术，训练过程活泼有趣，让孩子享受运动、主动参与运动，帮助学生掌握多种基本运动技能和器械操控技能，使孩子拥有并保持良好的身体素质和体能，从小养成受益终生的运动习惯，为当前或日后参与更高级的体育活动、学习和生活打下良好的基础。</p>
            <span class="STYLE1">              
              </span>
        </div>
    </div>
    <div class="m__w--fit fill STYLE1">
        <div class="grid">
            @foreach ($channels2 as $channel)
                @if (count($channel->child) > 0 && $channel->id == 29)
                    @foreach ($channel->child as $child)
                        @if($child->id == '35'||$child->id == '34')
                        <div class="col span-4 large-push-4 medium-push-4 small-push-4 xsmall-3">
                            <div class="box" style="background-image:url({{ $child->thumb }});">
                                <h3>
                                    <a href="{{ url($child->url) }}">
                                        <span class="box__t vertical-center">{{ $child->title }}<br></span>
                                    </a>
                                </h3>
                            </div>
                        </div>
