...
<div class="m__w">
    ...
    <div class="page__t col span-4 xsmall-6">
        ...
        <p class="page__t__desc">
            <span class="STYLE4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;跑沃尔运动馆除拥有少儿综合体能训练、趣味攀岩等核心课程外，还研发了适于不同年龄段少儿的特色课程，如跑步、攀岩、体操、球类等专项运动，满足不同孩子的个性化需求，同时让孩子拥有更多选择和挑战。</span><br><br>
        </p>
    </div>
</div>
<div class="m__w--fit fill">
    <div class="grid">
            @foreach ($channels2 as $channel)
                @if (count($channel->child) > 0 && $channel->id == 30)
                    @foreach ($channel->child as $child)
        ...
        <div class="col span-4 large-push-4 medium-push-4 small-push-4 xsmall-3">
            <div class="box" style="background-image:url({{ $child->thumb }});">
                <a href="{{ url($child->url) }}" >
                    <span class="box__t vertical-center">
            ...
            @endforeach
        <!-- <div class="col span-4 large-push-4 medium-push-4 small-push-4 xsmall-3">
            <div class="box" style="background-image:url(http://www.paowoer.com/img/class2.jpg);">
                <a href="{{ url('power/shinei') }}" >
                    <span class="box__t vertical-center">
                        <h3><span>旱地冰球（6-18岁）</span></h3>
                    </span>
                </a>
            </div>
        </div> -->
