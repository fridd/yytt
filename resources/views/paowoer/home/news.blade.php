    ...
    <div class="m__w">
        <div class="page__t col span-12">
            ...
            <div class="contenttype-listing">
                <div class="contenttype-listing">
                <div id="dealer-list" class="distributors-list">
                @foreach ($news as $element)
                    <div class="dealer col span-3 small-12 xsmall-6">
                        <div class="col span-1 small-12 xsmall-6"></div>
                            <h5 align="center"><strong>{{ $element->title }}</strong></h5>
                            <br>
                            <p class="store-address">{{ $element->digest }}</p>
                            <p class="email">{{ $element->source }}</p>
                            <p class="email"></p>
                            <a class="button button--link" href="{{url('power/newslist?id='.$element->id)}}" >阅读更多</a>
                            <hr class="simple-white">
                    </div>
                    <div class="col span-1 small-12 xsmall-6"></div>
                @endforeach
