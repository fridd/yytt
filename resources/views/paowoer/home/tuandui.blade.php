...
<ul>
    ...
    @endforeach   
<!-- <li><a href="{{ asset('paowoer/images/jl1.jpg') }}" ><img alt="" src="{{ asset('paowoer/images/jl1.jpg') }}"  /></a></li>
<li><a href="{{ asset('paowoer/images/jl2.jpg') }}" ><img alt="" src="{{ asset('paowoer/images/jl2.jpg') }}"  /></a></li>
 -->
</ul>                    
</div>
<div class="rider-stats">
    <p class="rider-stats">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    {!! $new->content !!}
   <!--  跑沃尔体能馆的教练均来自国内知名体育院校，多年的体能训练和研究经验让他们能快速精准地判断学员的身心状况，制订适于学员的训练计划，并提供多方位的个性化服务。此外，跑沃尔核心教练团还定期赴外交流学习，获取更多、更新的少儿体能培训研发成果，不断更新升级课程和服务。 --></p>
</div>
