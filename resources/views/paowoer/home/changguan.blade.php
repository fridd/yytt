    ...
    <div class="m__w">
        <div class="grid">
            <div class="col span-5 small-12 xsmall-6">
                <div class="rider-cnt">
                    <h1 class="rider-name">Paowoer<span>超大场馆</span></h1>
...
<ul>
    ...
    @endforeach   
    <!-- <li><a href="{{ asset('paowoer/images/cp1.jpg') }}" ><img alt="" src="{{ asset('paowoer/images/cp1-1.jpg') }}"  /></a></li>
    <li><a href="{{ asset('paowoer/images/cp2.jpg') }}" ><img alt="" src="{{ asset('paowoer/images/cp2-2.jpg') }}"  /></a></li>
    <li><a href="{{ asset('paowoer/images/cp3.jpg') }}" ><img alt="" src="{{ asset('paowoer/images/cp3-3.jpg') }}"  /></a></li>
    <li><a href="{{ asset('paowoer/images/cp4.jpg') }}" ><img alt="" src="{{ asset('paowoer/images/cp4-4.jpg') }}"  /></a></li> -->
</ul>                    
</div>
...
<div class="page-bg" style="background-image: url(http://www.paowoer.com/img/cg.jpg);"></div>
                </div>
            </div>
        </div>
<footer class="f">
