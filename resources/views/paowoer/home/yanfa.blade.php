    ...
    <div class="m__w">
        <div class="grid">
            <div class="col span-5 small-12 xsmall-6">
                <div class="rider-cnt">
                    <h1 class="rider-name">Paowoer<span>研发</span></h1>
...
<ul>
    ...
    @endforeach   
<!-- <li><a href="{{ asset('paowoer/images/yf1.jpg') }}" ><img alt="" src="{{ asset('paowoer/images/yf1-1.jpg') }}"  /></a></li>
<li><a href="{{ asset('paowoer/images/yf2.jpg') }}" ><img alt="" src="{{ asset('paowoer/images/yf2-2.jpg') }}"  /></a></li>
<li><a href="{{ asset('paowoer/images/yf3.jpg') }}" ><img alt="" src="{{ asset('paowoer/images/yf3-3.jpg') }}"  /></a></li>
<li><a href="{{ asset('paowoer/images/yf4.jpg') }}" ><img alt="" src="{{ asset('paowoer/images/yf4-4.jpg') }}"  /></a></li> -->
</ul>                    
</div>
<div class="rider-stats">
    ...
    <!-- 为让更多孩子参与体能训练，跑沃尔成立了体能研究与发展中心，专门从事体能课程的研究与推广，不以盈利为目的，开发幼儿园体能课程及教材，定期为幼儿园孩子提供免费培训和指导，每年为孩子进行体质检测2次，定期举办家长课堂，让更多家长认识少儿体能锻炼，让更多孩子从体能训练中受益。 --></p>
</div>
...
<div class="page-bg" style="background-image: url(http://www.paowoer.com/img/yf.jpg);"></div>
