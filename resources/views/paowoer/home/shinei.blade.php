...
<title>跑沃尔丨运动课程</title>
<meta name="description" content="跑沃尔体能,合肥少儿体能训练馆,合肥室内攀岩,合肥旱地冰球,运动,合肥儿童健身,合肥亲子运动馆,合肥童训营,合肥少儿户外运动,合肥少儿室内运动,美国少儿体能认证,www.paowoer.com,少儿运动装备，合肥轮滑训练，体能训练课程" />
<meta name="keywords" content="体能，体能训练，少儿体能训练，合肥攀岩，合肥室内攀岩，轮滑，旱地冰球，跆拳道" />
            ...
            <div class="h__w">
                <div class="grid">
                    <div class="col span-4 small-12 xsmall-6">
                        <h1 class="h__logo"><a href="{{ asset('power/index') }}"  title="Leader Bikes"><img src="{{ asset('paowoer/images/logo.png') }}"  alt="Leader Bikes" /></a></h1>
                    </div>
              ...
              <div class="h__r">
                    ...
                    <nav class="h__nv show-xsmall">
                        ...
                        <ul class="drop drop--down" id="h__nv--xsmall" data-drop-menu>
                            ...
                            @endforeach
                         <!-- <li><strong><a href="/power/paowoer">PAOWOER</a></strong></li>
                            <li><a href="/power/class" ><strong>课程介绍</strong></a></li>
                            <li><a href="/power/tuandui" ><strong>TEAM</strong></a></li>
                            <li><a href="/power/changjianwenti" ><strong>常见问题</strong></a></li>
                            <li><a href="/power/news" ><strong>NEWS</strong></a></li>
                            <li><a href="/power/contact" ><strong>联系我们</strong></a></li> -->
                        </ul>
                    </nav>
                </div>
            </div>
...
<!-- <div class="m page">
    <script type="text/javascript" src="{{ asset('paowoer/js/header2-2.js') }}"></script>
    </div> -->
    <div class="page__nv">
    <div class="page__nv__w">
        <h4 class="subnav-parent">
            <a href="/power/paowoer">课程介绍</a></h4>
        <div id="subnav" class="hide-xsmall">
          <div class="viewport">
            <ul class="overview">
                @foreach ($channels2 as $channel)
                  @if (count($channel->child) > 0 && $channel->id == 30)
    ...
    <div class="m__w">
       ...
       <div class="grid">
            <div class="col span-5 small-6 xsmall-6">
                <div class="blog-cnt">
                    <div class="blog-meta">
                        <div class="blog-meta__cat"><strong>课程介绍</strong></div>
                        <div class="blog-meta__date">Paowoer</div>
                    </div>
                    <h1><strong>旱地冰球</strong></h1>
...
<br>
<div id="weibo" class="panel" align="center">
    <ul class="panel_head">
      <div align="center"><span>跑沃尔体能微博</span></div>
    </ul>
    <ul class="panel_body">
        <iframe id="weibo" style="width:320px; height:500px;" frameborder="0" scrolling="no" src="http://v.t.sina.com.cn/widget/widget_blog.php?uid=5949799275"></iframe>
    </ul>
</div>
                </div>
            </div>
