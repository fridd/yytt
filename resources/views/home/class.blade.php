    ...
    <div class="m__w">
        ...
        <div class="page__t col span-4 xsmall-6">
            ...
            <p class="page__t__desc">
                                    <span class="STYLE4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;跑沃尔运动馆除拥有少儿综合体能训练、趣味攀岩等核心课程外，还研发了适于不同年龄段少儿的特色课程，如跑步、攀岩、体操、球类等专项运动，满足不同孩子的个性化需求，同时让孩子拥有更多选择和挑战。</span><br>
<br>                            </p>
        </div>
    </div>
    <div class="m__w--fit fill">
                            ...
                            <div class="box" style="background-image:url(http://www.paowoer.com/img/class1.jpg);">
                                <a href="{{ asset('power/zhtn') }}" >
                                    <span class="box__t vertical-center">
                                        <span>基础体能(3-18岁)</span></h3>
                                    </span>
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="box" style="background-image:url(http://www.paowoer.com/img/class2.jpg);">
                                <a href="{{ asset('power/shinei') }}" >
                                    <span class="box__t vertical-center">
                                        <span>旱地冰球（6-18岁）</span></h3>
                                    </span>
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="box" style="background-image:url(http://www.paowoer.com/img/class3.jpg);">
                                <a href="{{ asset('power/huwai') }}" >
                                    <span class="box__t vertical-center">
                                        <span>跆拳道（4-18岁）</span></h3>
                                    </span>
                                </a>
                            </div>
                        </div>
