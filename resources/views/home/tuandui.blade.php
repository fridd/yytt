...
<meta name="keywords" content="体能，体能训练，少儿体能训练，合肥攀岩，合肥室内攀岩，轮滑，冰球，户外运动" />
    ...
    <div class="m__w">
        <div class="grid">
            <div class="col span-5 small-12 xsmall-6">
                <div class="rider-cnt">
                    <h1 class="rider-name">Paowoer<span>教练</span></h1>
...
<ul>
<li><a href="../media/wysiwyg/team/bwagner/jl1.jpg" ><img alt="" src="../media/wysiwyg/team/bwagner/jl1-1.jpg"  /></a></li>
<li><a href="../media/wysiwyg/team/bwagner/jl2.jpg" ><img alt="" src="../media/wysiwyg/team/bwagner/jl2-2.jpg"  /></a></li>

</ul>                    </div>
                    <div class="rider-stats">
                        <p class="rider-stats">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;跑沃尔体能馆的教练均来自国内知名体育院校，多年的体能训练和研究经验让他们能快速精准地判断学员的身心状况，制订适于学员的训练计划，并提供多方位的个性化服务。此外，跑沃尔核心教练团还定期赴外交流学习，获取更多、更新的少儿体能培训研发成果，不断更新升级课程和服务。</p>
                    </div>
...
<div class="page-bg" style="background-image: url(http://www.paowoer.com/img/jl.jpg);"></div>
                </div>
            </div>
        </div>
                <footer class="f">
