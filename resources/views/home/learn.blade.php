    ...
    <div class="col-md-12">
       ...
       <!--  <div class="about-title" style="margin-top: 10px">
        ...
        <div class="col-md-12" style="margin-top: 18px">
            <div class="col-md-8" style="background: rgb(143,196,62);">
                {{--  在这里做判断  develop --}}
            ...
            @endif
               ...
               <!--  每個人都需要教育帶來及競爭力的肯定，藝術學習者同時也需要對藝術學習充滿信心。考試和證書不是目的，而是幫助藝術學習者建立自信、自我檢測的一種方式，我們長遠的目標是透過藝術教育帶來更美好的生活。 -->
            
            <div class="col-md-4">
            	<img src="{{ asset('images/a-1.png') }}" style="width: 100%">
