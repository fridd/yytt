...
@section('content')
    <div style="padding: 15px;">
        ...
        @if (isset($model))
        {!! Form::model($model, ['url' => ['admin/news', $model->id], 'class'=> 'layui-form', 'method'=> 'PUT', 'id' => 'formNew']) !!}
        @else
        {!! Form::open(['url' => 'admin/news', 'class' => 'layui-form', 'id'=>'formNew']) !!}
        @endif
        ...
        <div class="layui-form-item" pane="">
            ...
            <div class="layui-input-block">
              <input type="checkbox" name="newsint[yzyx]" value="1" lay-skin="primary" title="集团官网" @if(session('siteid') == 1)  checked="" @endif>
              <input type="checkbox" name="newsint[hfyzyx]" value="3" lay-skin="primary" title="合肥艺朝艺夕" @if(session('siteid') == 3)  checked="" @endif>
              <input type="checkbox" name="newsint[hfpwe]" value="2" lay-skin="primary" title="合肥跑沃尔" @if(session('siteid') == 2)  checked="" @endif>
              <input type="checkbox" name="newsint[hffeyy]" value="4" lay-skin="primary" title="合肥弗恩英语" @if(session('siteid') == 4)  checked="" @endif>
              <!-- <input type="checkbox" name="newsint[njyzyx]" value="5" lay-skin="primary" title="南京艺朝艺夕">
              <input type="checkbox" name="newsint[njpwe]" value="6" lay-skin="primary" title="南京跑沃尔">
              <input type="checkbox" name="newsint[njfeyy]" value="7" lay-skin="primary" title="南京弗恩英语" >
              <input type="checkbox" name="newsint[hzyzyx]" value="8" lay-skin="primary" title="杭州艺朝艺夕">
              <input type="checkbox" name="newsint[hzpwe]" value="9" lay-skin="primary" title="杭州跑沃尔">
              <input type="checkbox" name="newsint[hzfeyy]" value="10" lay-skin="primary" title="杭州弗恩英语" > -->
