...
<div style="padding: 15px;">
	...
	<div class="layui-form-item">
		...
		<div class="layui-inline">
			{!! Form::label('single', '是否单页面', ['class' => 'layui-form-label']) !!}
			<div class="layui-input-block">
				{!! Form::radio('single', 1, isset($model) ? $model->single : null, ['title' => '是']) !!}
				{!! Form::radio('single', 0, isset($model) ? $model->single : true, ['title' => '否']) !!}
