...
@section('content')
<blockquote class="layui-elem-quote">留言管理</blockquote>
    ...
    <tbody>
        @if (isset($messages)) 
            ...
            <tr>
                ...
                <td>
                    <a href="{{ url('/contact?cate=messages&message='.$message->id) }}" target="_blank" class="layui-btn layui-btn-small layui-btn-primary layuiBtn">查看</a>
