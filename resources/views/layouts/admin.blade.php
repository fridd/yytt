...
<head>
    ...
    <style type="text/css">
        ...
        .layui-table td{max-width: 290px; max-height: 80px;overflow: hidden;}
...
<body>
    <div class="layui-layout layui-layout-admin">
        ...
        {{--         @if (Entrust::hasRole('admin') || Entrust::can('gll'))
                    <li class="layui-nav-item"><a href="{{ url('/admin/site/jtgw') }}">集团网站</a></li>            
                @endif
                @if (Entrust::hasRole('admin') || Entrust::can('filiale'))
                    <li class="layui-nav-item"><a href="">分公司网站</a></li>
                @endif --}}
                @if (Entrust::hasRole('admin') || Entrust::can('wechat'))
                    <li class="layui-nav-item"><a href="{{ url('/admin/wechat') }}">微信运营</a></li>
                @endif
                @role('admin')
                <li class="layui-nav-item"><a href="{{ url('/admin/user') }}">权限管理</a></li>
                @endrole
                <li class="layui-nav-item"><a href="{{ url('/admin/sites') }}">站点管理</a></li>
            </ul>
