...
function weibo_txtload() {
    var innerHtml = "<span>分享到</span><img src=\"img/weibo/weixin.png\"  onclick=\"data_share();return false;\" alt=\"扫描二维码\" title=\"扫描二维码\" />" +
	    "<img src=\"img/weibo/xinl.png\" onclick=\"data_sendto('tsina');return false;\" alt=\"分享到新浪微博\" title=\"分享到新浪微博\" />" +
	    "<img src=\"img/weibo/tengxun.png\" onclick=\"data_sendto('tqq');return false;\" alt=\"分享到腾讯微博\" title=\"分享到腾讯微博\" />" +
	 "<img src=\"img/weibo/163.png\" onclick=\"data_sendto('t163');return false;\" alt=\"分享到网易微博\" title=\"分享到网易微博\" />" +
    "<img src=\"img/weibo/souhu.png\" onclick=\"data_sendto('tsohu');return false;\" alt=\"分享到搜狐微博\" title=\"分享到搜狐微博\" />"+
    "<img src=\"img/weibo/renren.png\" onclick=\"data_sendto('renren');return false;\" alt=\"分享到人人网\" title=\"人人网\" />" +
    "<img src=\"img/weibo/kaixin001.gif\" onclick=\"data_sendto('kaixin001');return false;\" alt=\"分享到开心网\" title=\"分享到开心网\" />" +
    ...
    var ec = encodeURIComponent,
        ...
        codeurl = A + C;
		var innerHtmlCode="<div class=\"pull-left\" style=\"width:91px;\">  <img src=\"" + codeurl +     "\" class=\"qrshare\" /><a onclick=\"data_close();return false;\" id=\"tip_share_close\"></a><i id=\"tipxjt\"></i></div><p class=\"share_qr_intro pull-left text-left\">用微信扫描二维码<br>分享至好友和朋友圈</p>"
